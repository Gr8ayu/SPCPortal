...
urlpatterns = [
    ...
    path(
        "profile/edit/contact/", views.edit_contact_details,
        name="edit_profile_contact"
    ),
    path(
        "profile/edit/education/",
        views.edit_education_details,
        name="edit_profile_education",
    ),
    path(
        "profile/edit/details/", views.edit_profile_details,
        name="edit_profile_details"
    ),
    path("offers/", login_required(views.OfferListView.as_view()),
         name="offers"),
    path(
    ...
    path(
        "companies/", login_required(views.CompanyListView.as_view()),
        name="companies"
    ),
    path(
        "company/details/<int:pk>/",
